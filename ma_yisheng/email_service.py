...
def send_verification_email(to_email, code, smtp_config):
    try:
        ...
        from_name = smtp_config.get("from_name", "码医生")
        try:
            port = int(port)
...
<div style="max-width: 420px; margin: 0 auto; background: #fff; border: 3px solid #000; padding: 24px;">
  <h2 style="color: #0D9488; margin-top: 0;">🐴 码医生 · 代码安全扫描</h2>
  <p style="font-size: 14px; color: #333;">你正在注册或登录码医生代码安全扫描平台，以下是你的验证码：</p>
